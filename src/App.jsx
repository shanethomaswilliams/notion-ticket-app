...
export default function TicketTracker() {
  ...
  const [tasks, setTasks] = useState([
    {
      ...
      description: "Check expiry and submit renewal form online",
      date: "2026-04-15",
      tagId: "t1",
      columnId: "todo",
    },
    {
      ...
      description: "Prepare capacity estimates for next quarter",
      date: "2026-04-02",
      tagId: "t2",
      columnId: "inprogress",
    },
  ...
  const addTag = () => {
    ...
    setTags((p) => [
      ...p,
      { id: genId("t"), name: newTagName.trim(), color: newTagColor },
    ]);
    setNewTagName("");
    setNewTagColor(
  ...
  const deleteColumn = (id) => {
    ...
    setTasks((p) =>
      p.map((t) => (t.columnId === id ? { ...t, columnId: "todo" } : t))
    );
  };
  ...
  const saveTask = () => {
    ...
    if (editingTask) {
      setTasks((p) =>
        p.map((t) =>
          t.id === editingTask.id
            ? { ...t, ...taskForm, title: taskForm.title.trim() }
            : t
        )
      );
    } else {
      ...
      >
        <div style={{ marginBottom: 24 }}>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            <button onClick={addTag} style={btnPrimary}>
              Add
            </button>
          </div>
          <div
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <input
              ...
              style={{ ...inputStyle, flex: 1 }}
            />
            <button onClick={addColumn} style={btnPrimary}>
              Add
            </button>
          </div>
        </div>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <select
                ...
                onChange={(e) =>
                  setTaskForm((f) => ({ ...f, tagId: e.target.value }))
                }
